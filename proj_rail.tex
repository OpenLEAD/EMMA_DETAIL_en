\subsubsection{Projects of robots on rails}\label{proj_rail}
...
%capacidade de satisfazer todos os requisitos, até agora observados, para a
% realização de um processo de inspeção e metalização utilizando a técnica HVOF. O desenvolvimento
%de um sistema compacto para o transporte através dos dutos de acesso e
% instalção no camara da turbina é possível, pois o tamanho necessário do manipulador pode
...
% proposto se trata de um manipulador robótico, com fixação diretamente na própria pá da
%turbina. \textbf{O tamanho do manipulador tem relação direta com o tamanho e
%peso do mecanismo de metalização. Outro fator determinante para a viabilidade
% da solução é o espaço de trabalho disponível e a distância que o efetuador deve
